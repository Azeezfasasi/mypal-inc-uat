  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our blog posts for the latest industry news, interviews, technologies, and resources." />
        <meta name="keywords" content="blog, articles, industry news, interviews, technologies, resources" />
        <link rel="canonical" href="https://www.mypal-inc.com/blog-lists" />
      </Helmet>
      ...
      <div className="min-h-screen bg-white py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            ...
            <div>
              {posts.length === 0 ? (
                <div className="py-20 text-center text-gray-500">No blog posts available.</div>
              ) : (
