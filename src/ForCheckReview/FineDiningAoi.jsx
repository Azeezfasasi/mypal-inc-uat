...
//       try {
//         const res = await fetch(`${API_BASE}/fine-dining/by-cuisine`, {
//           headers: {
...
//   if (loading) return <p className="text-blue-500">Loading API data...</p>;
//   if (error) return <p className="text-red-500">Error: {error}</p>;

//   return (
//     <div className="p-4 bg-gray-100 rounded-lg shadow-md">
//       <h2 className="text-lg font-bold mb-2">API Structure: Fine Dining by Cuisine</h2>
