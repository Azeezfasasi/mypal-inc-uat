...
const HomeBlog = () => {
  ...
  return (
    <section className="w-full bg-white py-8 px-4 md:px-8 lg:px-16 babas-font" id="home-blog">
      {/* Section header */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 flex justify-center md:hidden">
          <Link to="/blog-lists" className="px-4 py-2 bg-[#ce4015] text-white rounded-md bebas-font">View All Posts</Link>
        </div>
