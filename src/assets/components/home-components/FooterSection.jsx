...
const FooterSection = () => {
    ...
    return (
        <div className="bg-[#12416b] text-white font-sans antialiased p-8 md:p-12 lg:p-16 rounded-t-3xl md:rounded-t-[4rem] bebas-font">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    <h3 className="text-[#fbfbfb] text-left text-xl font-bold mb-4">MyPal</h3>
                    <p className="text-[#fbfbfb] text-base mb-6 max-w-xs mont-normal-font">
                ...
                {/* Column 2: Discover */}
                <div className="flex flex-col items-center md:items-start text-center md:text-left bebas-font">
                    <div className="text-[#fbfbfb] text-left text-xl font-bold mb-4">Discover</div>
                    <ul className="space-y-2 text-[#fbfbfb] text-base font-thin mont-normal-font">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left bebas-font">
                    <h3 className="text-[#fbfbfb] text-left text-xl font-bold mb-4">Connect with us</h3>
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                        ...
                        <a href="https://www.instagram.com/mypaltrybe_?igsh=ZjExMXhldnViamcy" target='_blank' className="text-white hover:text-gray-400 transition-colors duration-200"><Instagram className="w-6 h-6" /></a>
                    </div>
                    
                    {/* Address */}
                    <div className="flex items-start space-x-2 text-sm text-gray-300 mb-3 mont-normal-font">
                    ...
                    {/*Phone */}
                    <div className="flex items-center space-x-2 text-sm text-gray-300 mb-3 text-left mont-normal-font">
                        <FaWhatsapp className="w-6 h-6 text-white" />
                        <a href="https://wa.me/2349055557535" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200 text-[#ffffff] text-base font-normal relative">
                        09055557535</a>
                    </div>

                    {/* Email */}
                    <div className="flex items-center space-x-2 text-sm text-gray-300 mb-6 mont-normal-font">
                        <img src={sms} alt="" />
                        <a href="mailto:hello@mypal-inc.com" className="hover:text-white transition-colors duration-200 text-[#ffffff] text-base font-normal relative">hello@mypal-inc.com</a>
                    </div>
                    ...
                    >
                        <span className="font-semibold text-lg mr-3 bebas-font">Contact Us</span>
            ...
            {showContactModal && (
                <div className="fixed inset-0 z-[999999] flex items-center justify-center bebas-font">
