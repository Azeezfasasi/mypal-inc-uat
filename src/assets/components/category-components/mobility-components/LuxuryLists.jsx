...
export default function LuxuryLists({ subcategorySlug = 'Luxury on Demand' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Luxury filterCategoryId:', filterCategoryId);
        console.log('🔍 Luxury subcategory:', subcategory);
        ...
        console.log('📦 Luxury API Response:', resp.data);
        ...
        console.log(`📋 Luxury: Got ${dataArr.length} businesses`);
