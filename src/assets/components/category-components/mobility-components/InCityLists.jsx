...
//     return (
//         <div className="bg-gray-50 py-0 md:py-0 font-sans antialiased my-6">
...
export default function InCityLists() {
  ...
  const CATEGORY_ID = 'a53dfa5d-3098-4b1a-a2d8-7defdccdd09c'; 
  ...
  useEffect(() => {
    const fetchFineDining = async () => {
      ...
      try {
        const endpoint = `${API_BASE}/business-categories/${CATEGORY_ID}/businesses`;
    ...
    if (API_BASE && API_KEY && CATEGORY_ID) fetchFineDining();
