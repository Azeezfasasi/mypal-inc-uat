...
export default function HouseholdLists({ subcategorySlug = 'Household Logistics' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Household filterCategoryId:', filterCategoryId);
        console.log('🔍 Household subcategory:', subcategory);
        ...
        console.log('📦 Household API Response:', resp.data);
        ...
        console.log(`📋 Household: Got ${dataArr.length} businesses`);
