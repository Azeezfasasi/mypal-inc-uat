...
export default function ConcertAndShowsList({ subcategorySlug = 'Concerts & Shows' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Concert & Shows filterCategoryId:', filterCategoryId);
        console.log('🔍 Concert & Shows subcategory:', subcategory);
        ...
        console.log('📦 Concert & Shows API Response:', resp.data);
        ...
        console.log(`📋 Concert & Shows: Got ${dataArr.length} businesses`);
