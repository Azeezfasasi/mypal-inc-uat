...
export default function PrivateCinemaList({ subcategorySlug = 'Private Cinemas' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Private Cinema filterCategoryId:', filterCategoryId);
        console.log('🔍 Private Cinema subcategory:', subcategory);
        ...
        console.log('📦 Private Cinema API Response:', resp.data);
        ...
        console.log(`📋 Private Cinema: Got ${dataArr.length} businesses`);
