...
const heroImage = restauranthero2;
        ...
        <div className="relative w-full h-[800px] md:h-[676px]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 md:px-8">
                ...
                <div className="w-full md:w-[95%] flex flex-col gap-4 items-center justify-start relative mt-[-120px] md:mt-[-160px] mb-16">
                    <div className="bg-[rgba(255,255,255,0.34)] rounded-[50px] border-solid border-[rgba(255,255,255,0.41)] border shrink-0 w-[350px] md:w-[433px] h-[55px] md:h-[33px] relative overflow-hidden" style={{ backdropFilter: "blur(8.7px)" }}>
                        <div className="text-[#ffffff] text-center font-['AvenirNextRoundedStd-Regular',_sans-serif] text-sm font-normal absolute left-1 md:left-5 top-2 flex items-center justify-center px-2 md:px-0">
                        Culinary Experiences - Savor every bite, discover every flavor.
                        </div>
                    </div>
