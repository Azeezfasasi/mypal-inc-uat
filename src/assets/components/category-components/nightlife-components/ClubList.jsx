...
export default function ClubList({ subcategorySlug = 'Club' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Club filterCategoryId:', filterCategoryId);
        console.log('🔍 Club subcategory:', subcategory);
        ...
        console.log('📦 Club API Response:', resp.data);
        ...
        console.log(`📋 Club: Got ${dataArr.length} businesses`);
