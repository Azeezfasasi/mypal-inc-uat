...
export default function HappeningList({ subcategorySlug = 'Happening this month' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Happening This Month filterCategoryId:', filterCategoryId);
        console.log('🔍 Happening This Month subcategory:', subcategory);
        ...
        console.log('📦 Happening This Month API Response:', resp.data);
        ...
        console.log(`📋 Happening This Month: Got ${dataArr.length} businesses`);
