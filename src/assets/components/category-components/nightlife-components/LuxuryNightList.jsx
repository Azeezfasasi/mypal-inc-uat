...
export default function LuxuryNightList({ subcategorySlug = 'Luxury Nightlife' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Luxury Night List filterCategoryId:', filterCategoryId);
        console.log('🔍 Luxury Night List subcategory:', subcategory);
        ...
        console.log('📦 Luxury Night List API Response:', resp.data);
        ...
        console.log(`📋 Luxury Night List: Got ${dataArr.length} businesses`);
