...
export default function EventNightList({ subcategorySlug = 'Events Nights' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Event Night filterCategoryId:', filterCategoryId);
        console.log('🔍 Event Night subcategory:', subcategory);
        ...
        console.log('📦 Event Night API Response:', resp.data);
        ...
        console.log(`📋 Event Night: Got ${dataArr.length} businesses`);
