...
export default function BeachesLists({ subcategorySlug = 'Beaches & Resorts' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Beaches & Resorts filterCategoryId:', filterCategoryId);
        console.log('🔍 Beaches & Resorts subcategory:', subcategory);
        ...
        console.log('📦 Beaches & Resorts API Response:', resp.data);
        ...
        console.log(`📋 Beaches & Resorts: Got ${dataArr.length} businesses`);
