...
export default function BoatLists({ subcategorySlug = 'Boat & Yacht Cruises' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Boat & Yacht Cruises filterCategoryId:', filterCategoryId);
        console.log('🔍 Boat & Yacht Cruises subcategory:', subcategory);
        ...
        console.log('📦 Boat & Yacht Cruises API Response:', resp.data);
        ...
        console.log(`📋 Boat & Yacht Cruises: Got ${dataArr.length} businesses`);
