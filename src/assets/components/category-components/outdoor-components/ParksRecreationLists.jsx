...
export default function PacksRecreationLists({ subcategorySlug = 'Parks & Recreation' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Pack and Recreation filterCategoryId:', filterCategoryId);
        console.log('🔍 Pack and Recreation subcategory:', subcategory);
        ...
        console.log('📦 Pack and Recreation API Response:', resp.data);
        ...
        console.log(`📋 Pack and Recreation: Got ${dataArr.length} businesses`);
