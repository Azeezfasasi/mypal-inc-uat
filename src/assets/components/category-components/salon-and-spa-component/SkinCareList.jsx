...
export default function SkincareList({ subcategorySlug = 'Spa & Skin Care' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('📦 Spa & Skin Care API Response:', resp.data);
        ...
        console.log(`📋 Spa & Skin Care: Got ${dataArr.length} businesses`);
