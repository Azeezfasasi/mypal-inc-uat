...
export default function FitnessAndGymList({ subcategorySlug = 'Fitness & Gym' }) {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Fitness And Gym filterCategoryId:', filterCategoryId);
        console.log('🔍 Fitness And Gym subcategory:', subcategory);
        ...
        console.log('📦 Fitness And Gym API Response:', resp.data);
        ...
        console.log(`📋 Fitness And Gym: Got ${dataArr.length} businesses`);
