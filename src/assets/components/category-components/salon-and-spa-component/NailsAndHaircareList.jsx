  ...
  useEffect(() => {
    async function fetchBusinesses() {
      try {
        ...
        console.log('🔍 Nails & Hair Care filterCategoryId:', filterCategoryId);
        console.log('🔍 Nails & Hair Care subcategory:', subcategory);
        ...
        console.log('📦 Nails & Hair Care API Response:', resp.data);
        ...
        console.log(`📋 Nails & Hair Care: Got ${dataArr.length} businesses`);
